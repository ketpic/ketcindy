...
\itemketj{例} \verb|\circlemark[8]{1.2}| で ``\makebox[8mm]{\circlemark{1.2}}'' が出力される.\\
\Chuu 線の太さ(thickness)のデフォルトは12とする.
...
\itemketj{例} \verb|\circleshade[8]{1.2}{0.7}| で ``\makebox[8mm]{\circleshade[8]{1.2}{0.7}}'' が出力される.
%(pict2e非対応)% kubo231109
\end{cmd}
...
\itemketj{例}\verb|\lineseg[16]{60}{15}{30}{25}|\vspace{-2mm}
\itemketj{}\verb|\dashlineseg[16]{80}{15}{30}{25}|
...
\Chuu 鏃は始点(x, y)に描く. \\
\Chuu 線の太さ (thickness)のデフォルトは 12 (単位は milli inch).\\
\tab{\bs arrowhead は鏃だけを描く. sizeのデフォルトは 1倍}\\
\Chuu x, y, $\theta$ は小数でもよい.
\itemketj{例}\verb|\arrowlineseg[16]{60}{20}{10}{45}|\vspace{-2mm}
\itemketj{}\verb|\arrowhead[3]{80}{20}{45}|

\vspace*{-5mm}
\begin{layer}{160}{0}
\arrowlineseg[16]{60}{20}{10}{45}
\arrowhead[3]{80}{20}{45}
\end{layer}
...
\tab{\bs qarrowlinesize[thickness]\br{x}\br{y}\br{L}\br{$\theta$}\br{size}}
\itemketj{説明}{\tt \bs qarrowline}, {\tt\bs qarrowlinesize}は，点 (x, y) から長さ L (単位はmm) の矢印を $\theta^\circ$ 方向にctrで指定した曲がり具合で描く.
(これらは，pict2e限定)\\% kubo231115
\Chuu 鏃は始点(x, y)に描く. {{\tt\bs qarrowlinesize} は鏃の大きさを変更できる.}\\
\Chuu 線の太さ (thickness)のデフォルトは 12 (単位は milli inch).\\
\Chuu x, y, $\theta$ は小数でもよい.
\itemketj{例}\verb|\qarrowline[16]{60}{20}{10}{45}{30}|\vspace{-2mm}
\itemketj{}\verb|\qarrowlinesize[16]{80}{20}{10}{45}{30}{300}|

\vspace*{-5mm}
\begin{layer}{160}{0}
%\lineseg[16]{60}{20}{30}{25}
\qarrowline[16]{60}{20}{10}{45}{30}
\qarrowlinesize[16]{80}{20}{10}{45}{30}{300}
\end{layer}
...
\itemketj{使用法}\verb|\circleline[thickness]{x}{y}{size}|
\itemketj{説明}(x, y) を中心に円を描く. size=1のとき, 円の直径は4mm.
%\ (pict2e非対応)
\itemketj{例}\verb|\circleline[12]{40}{10}{2}|\vspace{3mm}

\begin{layer}{100}{20}
 \circleline[12]{40}{10}{2}
\end{layer}
\vspace{10mm}
...
\itemketj{例} {\bs ballon }, {\bs lefthand }などの例
