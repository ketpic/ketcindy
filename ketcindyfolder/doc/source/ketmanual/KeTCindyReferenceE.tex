...
\itemket{Detailse}Options are "Size=", "Color=", "notex/nodisp".
\itemket{Examples}\mbox{}
...
\hspace*{5mm}\verb|"Out=y/n(default:n)"| whether it uses R and make the data file or not.
\itemket{Examples}\mbox{}
...
Besides this, there are facing convex polyhedrons from n01 to n92.

cf.http://mitani.cs.tsukuba.ac.jp/polyhedron/
