...
\hypertarget{setedittextt}{}
\item[関数]Setedittext(識別番号,[初期文字列，文字サイズ，幅])
...
【例】Setedittext(0,["y=",18,300]); Text0の表示文字\verb|"y="|，文字サイズ18pt，幅300pt
...
\hyperlink{setedittext}{Setedittext(識別番号, 文字サイズ, 幅)}\>\verb|"Editable Text"|を設定する。\\
