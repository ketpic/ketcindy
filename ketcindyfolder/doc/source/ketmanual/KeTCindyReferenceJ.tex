...
注） 微分記号のプライムは，シングルクウォートまたはバッククウォート。ここからコピーアンドペーストするときは文字コードが変わっているので注意。
...
\end{verbatim}
\begin{layer}{150}{0}
\putnotese{50}{20}{ \input{Fig/sfbdpara05}}
\end{layer}
\begin{verbatim}
fd2=[
 "p",
...
\begin{layer}{150}{0}
\putnotese{70}{0}{ \input{Fig/wirepara5}}
\end{layer}
...
\begin{center} \input{Fig/crvsfparadata2}  \hspace{5mm}   \input{Fig/crvsfparadata1} \end{center}
