...
%\end{cmd}
%-------------arrowlineseg-------------------------------
\begin{cmd}{\bs arrowlineseg, \bs arrowhead}{arrowlineseg}
...
%-------------hjaggyline-------------------------------
\begin{cmd}{\bs vjaggyline, \bs vjaggylineb}{hjaggyline}
...
\tab{{\tt \bs ballonl}は (x, y) から左上に吹き出しと Char を描く.}
\end{cmd}
