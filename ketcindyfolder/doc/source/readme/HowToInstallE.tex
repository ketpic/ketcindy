...
\end{minipage}}
\putnotese{121}{25}{\fbox{Update}}
\putnotese{123}{32}{Update ketcindy in \TeX\ system}
\putnotese{123}{37}{\begin{minipage}[t]{52mm}%
{\color{red}If 'cannot execute' error occurs,}\\
\hfill(At the first time on Mac/Linux)\\
\hspace*{3mm}On Terminal, execute\\
\hspace*{5mm}cd (Drag\&Drop fig folder)\\
\hspace*{5mm}chmod 777 kc.command(sh)
\end{minipage}}
\putnotese{121}{59}{\fbox{Work}}
\putnotese{123}{66}{\begin{minipage}[t]{52mm}%
...
\item Test run
\begin{itemize}
\item Finish once Cinderella and double click \verb|testrun.cdy|.
\item Press \verb|Figure| button, and the pdf will be displayed.
\item See Readmemore when errors occur.
\end{itemize}
