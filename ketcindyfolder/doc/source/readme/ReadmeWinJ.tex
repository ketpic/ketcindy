...
\item Cinderella, R, Maxima, Sumatra をインストールする．
 \begin{itemize}
 \item \url{https://beta.cinderella.de}  (Cinderella)
 \item \url{https://cran.r-project.org}   (R)
 \item \url{https://sourceforge.net/projects/maxima/files}  (Maxima)
 \item \url{https://www.sumatrapdfreader.org/download-free-pdf-viewer.html} (Sumatra)\\
 \hspace*{5mm}注）Sumatraのインストール先をProgram FilesまたはProgram Files (x86)にする（オプション指定）．
 \end{itemize}
...
\hspace*{5mm}右クリックして「プロパティ」＞「セキュリティ」＞「許可」
  ...
  \hspace*{3zw}\Ltab{5zw}{KeTTeX} setketcindykettex.bat\\
  ...
  \hspace*{3zw}\Ltab{5zw}{他のTeX} setketcindy.bat（要修正）
   \begin{itemize}
    ...
    \item Pluginsにketcindy.iniが作成される（作成または再作成を選んだ場合）．
...
\item TeXworksの設定
 ...
 \hspace*{5mm}注）TeXLiveの場合も同様
  \item TeXworksを立ち上げて，「TeXworks \verb|>| ファイル \verb|>| 設定 \verb|>| タイプセット」
  \item 上の欄にTeXworksのパスが入っていることを確認する．
  \item 下の欄の横にある + をクリック
    \begin{itemize}
